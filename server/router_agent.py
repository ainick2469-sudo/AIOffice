...
KEYWORD_MAP = {
    ...
    "build": ["builder", "codex", "architect"],
    "make": ["builder", "codex", "architect"],
    ...
    "create": ["builder", "architect", "codex"],
    "app": ["builder", "architect", "uiux"],
    ...
    "implement": ["builder", "codex", "reviewer"],
